                    ...
                    <div class="col-sm-12">
                        <div class="visitors-chart">
                            <div class="panel-heading pink text-right">
                                <a class="graph_by" data-id="7">Last 7 Days</a> &nbsp; | &nbsp; 
                                 <a class="graph_by" data-id="30">Last 30 Days</a>  &nbsp;| &nbsp;
                                <a class="graph_by" data-id="365">Last 12 Month</a>
                    ...
                    @if (!empty($sales))
                        @forelse ($sales as $key => $sale)
                            <tr>
                                ...
                                <td>
								  <a target="_blank" href="{{ url('reports/sales/' . $sale->id) }}" class="btn btn-primary btn-xs pull-right">Show</a>
