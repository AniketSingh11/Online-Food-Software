...
<div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
            <div class="row">
                <div class="col-lg-4">
                    <h3 class="comingOrder">New Orders</h3>
                    <div class="ibox">
                ...
                <div class="col-lg-4">
                    <h3 class="completeOrder">Completed</h3>
                    <div class="ibox">
                        <div class="ibox-content">
                ...
                <div class="col-lg-4">
                    <h3 class="cancelOrder">Cancelled</h3>
                    <div class="ibox">
                        <div class="ibox-content">
        ...
        <div class="modal-body" >
                <div class="col-sm-12">
                        <div class="col-sm-12 form-group">
                            <label>Name : <span id="name_order">  </span></label>                            
                        </div>
                        <div class="col-sm-12 form-group">
                            <label>Email : <span id="email_order">  </span></label>
                        </div>
                        <div class="col-sm-12 form-group">
                            <label>Phone number : <span id="phone_order">  </span></label>
                        </div>
                        <div class="col-sm-12 form-group">
                            <label>Address : <span id="address_order">  </span></label>
                        </div>
						
						<div class="col-sm-12 form-group">
                           <a target="_blank" href="javascript:void(0)" id="href_link" class="btn btn-primary"> Detail View</a>
                        </div>
                </div>
