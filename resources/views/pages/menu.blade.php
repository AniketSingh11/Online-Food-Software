        ...
        <div class="container">
                ...
                <div class="our-menu-details">
                    ...
                    <div class="col-xs-12 col-sm-2 col-lg-2 bg-grey menu-list no-pad">
                        ...
                        <ul class="">
                            ...
                            <li class="fil-cat" data-rel="{{$cat->id}}">{{$cat->name}}</li>
                            @endforeach
            ...
            ?>
                                ...
                                <div class="or-rgt-menu col-xs-12 col-sm-3">
                                    ...
                                    <h2 styleF="cursor:pointer;" class="AddToCart" data-price="{{$prices[$key]}}" data-id="{{$pro->id}}" data-key="{{$key}}" data-size="{{$t}}" data-name="{{$pro->name}}">+</h2>
                                </div>
         ...
         var cart_html = "";
             var obj = cart; 
                 ...
                 $.each( obj, function( key, value ) {
                      ...
                      cart_html += '<li><span><i data-id=' +  value.id + ' class="fa fa-minus-circle DecreaseToCart" aria-hidden="true"></i>&ensp;<i data-id=' +  value.id + ' class="fa fa-plus-circle IncreaseToCart" aria-hidden="true"></i></span>&ensp;<span class="">' + value.quantity +'x</span> ' + value.name + '<span class="pull-right">'+ value.price + ' <i class="fa fa-times-circle-o fa-lg DeleteItem" data-id=' +  value.id + '></i></span></li>';
